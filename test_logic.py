...
def is_valid_primary_chunk(chunk, source):
    ...
    Must have at least 5 words and come from Clarity or Elevate documents.
    Note: Updated to match actual implementation in slack_doc_bot.py
    """
    # Check word count (updated from 20 to 5 to match actual implementation)
...
def test_chunk_validation():
    ...
    # Test invalid chunk (too short - less than 5 words)
    invalid_short_chunk = "Too short."
    invalid_short_source = "clarity.pdf"
    
    # Test valid short chunk (5+ words)
    valid_short_chunk = "This is a valid chunk with five words minimum."
    valid_short_source = "clarity.pdf"
    ...
    tests = [
        ...
        ("Valid short chunk", valid_short_chunk, valid_short_source, True),
